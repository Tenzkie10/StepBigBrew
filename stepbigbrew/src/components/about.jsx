    ...
    return (
        <>
            <div className="about-page">
                ...
                <img className='a_image3' src={img3} alt="a_img3"></img>

                <img className='a_image4' src={img4} alt="a_img4"></img>

                <div className="a_overlay">
                    <p className="about_info"><i>Kirsten, Dominique, and Quian, three friends with a shared passion for coffee and web development, were nearing the end of their web development course. For their final project, they brainstormed ideas that combined their interests.
